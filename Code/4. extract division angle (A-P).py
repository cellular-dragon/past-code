# -*- coding: utf-8 -*-
"""
Created on Fri Feb 18 19:31:15 2022
...
import numpy as np
import math
import Ccell.cell_name_transfer as ct
...
#c = np.array([1,0,0])
#d = np.array([0,1,0])
def angle(a,b,c,d): #Calculate the angle between the space vectors ba and dc 
    Lba = np.sqrt((b-a).dot(b-a))
    Ldc = np.sqrt((d-c).dot(d-c))
    cos_angle = (b-a).dot(d-c)/(Lba*Ldc)
    angle = np.arccos(cos_angle)
    angle2=angle*360/2/np.pi
    return([angle,angle2])

Cell_list_357=['ABa','ABp','EMS','P2','ABal','ABala','ABalaa','ABalaaa','ABalaaaa','ABalaaaal','ABalaaaar','ABalaaap','ABalaaapa','ABalaaapp','ABalaap','ABalaapa','ABalaapaa','ABalaapap','ABalaapp','ABalaappa','ABalaappp','ABalap','ABalapa','ABalapaa','ABalapaaa','ABalapaap','ABalapap','ABalapapa','ABalapapp','ABalapp','ABalappa','ABalappaa','ABalappap','ABalappp','ABalapppa','ABalapppp','ABalp','ABalpa','ABalpaa','ABalpaaa','ABalpaaaa','ABalpaaap','ABalpaap','ABalpaapa','ABalpaapp','ABalpap','ABalpapa','ABalpapaa','ABalpapap','ABalpapp','ABalpappa','ABalpappp','ABalpp','ABalppa','ABalppaa','ABalppaaa','ABalppaap','ABalppap','ABalppapa','ABalppapp','ABalppp','ABalpppa','ABalpppaa','ABalpppap','ABalpppp','ABalppppa','ABalppppp','ABar','ABara','ABaraa','ABaraaa','ABaraaaa','ABaraaaaa','ABaraaaap','ABaraaap','ABaraaapa','ABaraaapp','ABaraap','ABaraapa','ABaraapaa','ABaraapap','ABaraapp','ABaraappa','ABaraappp','ABarap','ABarapa','ABarapaa','ABarapaaa','ABarapaap','ABarapap','ABarapapa','ABarapapp','ABarapp','ABarappa','ABarappaa','ABarappap','ABarappp','ABarapppa','ABarapppp','ABarp','ABarpa','ABarpaa','ABarpaaa','ABarpaaaa','ABarpaaap','ABarpaap','ABarpaapa','ABarpaapp','ABarpap','ABarpapa','ABarpapaa','ABarpapap','ABarpapp','ABarpappa','ABarpappp','ABarpp','ABarppa','ABarppaa','ABarppaaa','ABarppaap','ABarppap','ABarppapa','ABarppapp','ABarppp','ABarpppa','ABarpppaa','ABarpppap','ABarpppp','ABarppppa','ABarppppp','ABpl','ABpla','ABplaa','ABplaaa','ABplaaaa','ABplaaaaa','ABplaaaap','ABplaaap','ABplaaapa','ABplaaapp','ABplaap','ABplaapa','ABplaapaa','ABplaapap','ABplaapp','ABplaappa','ABplaappp','ABplap','ABplapa','ABplapaa','ABplapaaa','ABplapaap','ABplapap','ABplapapa','ABplapapp','ABplapp','ABplappa','ABplappaa','ABplappap','ABplappp','ABplapppa','ABplapppp','ABplp','ABplpa','ABplpaa','ABplpaaa','ABplpaaaa','ABplpaaap','ABplpaap','ABplpaapa','ABplpaapp','ABplpap','ABplpapa','ABplpapaa','ABplpapap','ABplpapp','ABplpappa','ABplpappp','ABplpp','ABplppa','ABplppaa','ABplppaaa','ABplppaap','ABplppap','ABplppapa','ABplppapp','ABplppp','ABplpppa','ABplpppaa','ABplpppap','ABplpppp','ABplppppa','ABplppppp','ABpr','ABpra','ABpraa','ABpraaa','ABpraaaa','ABpraaaaa','ABpraaaap','ABpraaap','ABpraaapa','ABpraaapp','ABpraap','ABpraapa','ABpraapaa','ABpraapap','ABpraapp','ABpraappa','ABpraappp','ABprap','ABprapa','ABprapaa','ABprapaaa','ABprapaap','ABprapap','ABprapapa','ABprapapp','ABprapp','ABprappa','ABprappaa','ABprappap','ABprappp','ABprapppa','ABprapppp','ABprp','ABprpa','ABprpaa','ABprpaaa','ABprpaaaa','ABprpaaap','ABprpaap','ABprpaapa','ABprpaapp','ABprpap','ABprpapa','ABprpapaa','ABprpapap','ABprpapp','ABprpappa','ABprpappp','ABprpp','ABprppa','ABprppaa','ABprppaaa','ABprppaap','ABprppap','ABprppapa','ABprppapp','ABprppp','ABprpppa','ABprpppaa','ABprpppap','ABprpppp','ABprppppa','ABprppppp','C','Ca','Caa','Caaa','Caaaa','Caaap','Caap','Caapp','Cap','Capa','Capaa','Capap','Capp','Cappa','Cappp','Cp','Cpa','Cpaa','Cpaaa','Cpaap','Cpap','Cpapa','Cpapp','Cpp','Cppa','Cppaa','Cppap','Cppp','Cpppa','Cpppp','D','Da','Daa','Dap','Dp','Dpa','Dpp','E','Ea','Eal','Eala','Ealp','Ear','Eara','Earp','Ep','Epl','Epla','Eplp','Epr','Epra','Eprp','MS','MSa','MSaa','MSaaa','MSaaaa','MSaaaaa','MSaaaap','MSaaap','MSaaapa','MSaap','MSaapa','MSaapaa','MSaapap','MSaapp','MSap','MSapa','MSapaa','MSapaaa','MSapap','MSapapa','MSapapp','MSapp','MSappa','MSappp','MSp','MSpa','MSpaa','MSpaaa','MSpaaaa','MSpaaap','MSpaap','MSpaapa','MSpap','MSpapa','MSpapaa','MSpapap','MSpapp','MSpp','MSppa','MSppaa','MSppaaa','MSppap','MSppapa','MSppapp','MSppp','MSpppa','MSpppp','P3','P4']

###################################################################################################


File_Directory = r'C:\Users\dell\Desktop\raw_data'   # input raw data of control or RNAi or RNAi_add
Spatial_Distance_Matrix_Folder=r'C:\Users\dell\Desktop\output_folder\RNAi_distance_matrix' # input the corresponding relative cell position distance matrix from "3. relative cell position distance matrix"
Output= r'C:\Users\dell\Desktop\output_folder\RNAi_division_angles_A-P.txt'  # assign the output folder path and file name
...
for each_emb in raw_data_list:
    ...
    emb_cell_list=list(set(emb_output_['cell_name']))
    
    emb_terminal_cell_list = get_terminal_cell(emb_cell_list)

    middle_cell_cell_list = list(set(emb_cell_list) - set(emb_terminal_cell_list))
    
    middle_cell_cell_list=list(set(middle_cell_cell_list).intersection(set(Cell_list_357)))

    middle_cell_cell_list.sort()
    ...
    dist_matrix_temp=os.path.join(Spatial_Distance_Matrix_Folder,embryo_name_+'_distMatrix_normalized.txt')
    dist_matrix_temp = pd.read_csv(dist_matrix_temp,index_col= 0,header=0,sep='\t')
    dist_matrix_temp=dist_matrix_temp.replace(0,np.nan)
    dist_matrix_temp=dist_matrix_temp.dropna(how='all',axis=1)
    dist_matrix_temp=dist_matrix_temp.dropna(how='all',axis=0)
    dist_matrix_temp=dist_matrix_temp.replace(np.nan,0)
    
    dist_matrix_array=np.array(dist_matrix_temp)
    
    cell_pair_position=np.where(dist_matrix_temp==np.max(dist_matrix_array))[0]
    
    cell1=dist_matrix_temp.columns[cell_pair_position[0]]
    cell2=dist_matrix_temp.index[cell_pair_position[-1]]
    cell_pair=[cell1,cell2]
                
    emb_output_distance_selected=emb_output_info.loc[cell_pair]               
    cell_name_index=list(zip(emb_output_distance_selected.index,emb_output_distance_selected['time']))
    emb_output_temp=emb_output_distance_selected.drop(['time'],axis=1)
    emb_output_temp.index=cell_name_index
    
    cell_pair_distance_all_tp=ss.distance.pdist(emb_output_temp)

    cell_pair_distance=pd.DataFrame(ss.distance.squareform(cell_pair_distance_all_tp),
                                    index=cell_name_index,columns=cell_name_index)
    cell_pair_distance_array=np.array(cell_pair_distance)
    cell_pair_timepoint=np.where(cell_pair_distance_array==np.max(cell_pair_distance_array))[0]
    
    cell_time1=cell_pair_distance.columns[cell_pair_timepoint[0]]
    cell_time2=cell_pair_distance.index[cell_pair_timepoint[-1]]
    
    time1=cell_time1[1]
    time2=cell_time2[1]
    
    if type(emb_output_info.loc[cell1])==pd.core.series.Series:
        coordinate1=np.array(emb_output_info.loc[cell1].drop('time')) 
        
    elif type(emb_output_info.loc[cell1])==pd.core.frame.DataFrame:
        coordinate1=np.array(emb_output_info.loc[cell1][emb_output_info.loc[cell1]['time']==time1][['X','Y','Z']].iloc[0])  
    
    if type(emb_output_info.loc[cell2])==pd.core.series.Series:
        coordinate2=np.array(emb_output_info.loc[cell2].drop('time')) 
    
    elif type(emb_output_info.loc[cell2])==pd.core.frame.DataFrame:
    
        coordinate2=np.array(emb_output_info.loc[cell2][emb_output_info.loc[cell2]['time']==time2][['X','Y','Z']].iloc[0])   

    axis_coordinate=[coordinate1,coordinate2]
    all_axis_coordinate.append(axis_coordinate)
   
    cell_list=[]
    cell_angle=[]
    
    for cell in middle_cell_cell_list:
        mother=ct.cell_name_transfer(cell)
        children_0=mother+'0'
        children_1=mother+'1'
        children_0=ct.cell_name_transfer(children_0)
        children_1=ct.cell_name_transfer(children_1)

        cell_list.append(cell)
        

        if type(emb_output_info.loc[children_0]['time'])==pd.core.series.Series:
            children_0_info=emb_output_info.loc[children_0].iloc[1]
            children_0_position=children_0_info.drop('time') 
        else:
            children_0_position=emb_output_info.loc[children_0].drop('time')                    
        
        if type(emb_output_info.loc[children_1]['time'])==pd.core.series.Series:
            children_1_info=emb_output_info.loc[children_1].iloc[1]
            children_1_position=children_1_info.drop('time') 
        else:
            children_1_position=emb_output_info.loc[children_1].drop('time')
                                    
        children_0_coordinate=np.array(children_0_position)
        children_1_coordinate=np.array(children_1_position)
        angle_value=angle(coordinate1,coordinate2,children_0_coordinate,children_1_coordinate)[1]
        if angle_value > 90:
            cell_angle.append(180-angle_value)
        else:
            cell_angle.append(angle_value)
      
    cell_angle=pd.DataFrame(cell_angle)    
    cell_angle.index=cell_list
    
    all_angles=pd.concat([all_angles,cell_angle],axis=1)
    a+=1
    print(a)
all_angles.columns=embryo_name
all_angles.to_csv(Output, sep="\t")
